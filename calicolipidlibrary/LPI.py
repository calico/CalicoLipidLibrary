    ...
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:
            ...
            if adduct == "[M+H]+":
                ...
                FRAGMENTS.append(
                    [MW("C6H13O9P") + ADDUCT[adduct], 22, "inositol-phosphate + adduct"]
                )
                FRAGMENTS.append(
                    [
                ...
                FRAGMENTS.append(
                    [MW("C6H12O6") - H2O + ADDUCT[adduct], 3, "inositol - water"]
                )
                ...
                FRAGMENTS.append(
                    [NL(self.chains[0]) - H2O + PROTON, 38, "sn1 acylium ion"]
                )
            ...
            if adduct in ["[M+Na]+", "[M+K]+", "[M+Li]+", "[M+NH4]+"]:
                ...
                FRAGMENTS.append(
                    [PREC - MW("C6H13O9P") + H2O, 30, "NL inositol-phosphate + water "]
                )
                FRAGMENTS.append(
                    [
                ...
                FRAGMENTS.append(
                    [MW("C6H12O6") + ADDUCT[adduct], 55, "inositol + adduct"]
                )
                FRAGMENTS.append(
                    [
                        MW("C6H12O6") - H2O + ADDUCT[adduct],
                        5,
                        "inositol - water + adduct",
                    ]
                )
                FRAGMENTS.append(
                    [MW("H3PO4") + ADDUCT[adduct], 5, "phosphoric acid + adduct"]
                )
                FRAGMENTS.append(
                    [
                        MW("C3H9O6P") - H2O + ADDUCT[adduct],
                        53,
                        "glycerol-P - water + adduct",
                    ]
                )
                FRAGMENTS.append(
                    [MW("C3H9O6P") + ADDUCT[adduct], 14, "glycerol-P  + adduct"]
                )
                ...
                for i in range(0, len(self.chains)):
                    ...
                    if self.chains[i][0] == 0:
                        continue
                    FRAGMENTS.append(
                        [NL(self.chains[i]) - H2O + PROTON, 5, "sn1 acylium ion"]
                    )
                    FRAGMENTS.append(
                        [PREC - NL(self.chains[i]) + H2O, 27, "NL sn1 ketene"]
                    )
            ...
            FRAGMENTS.append(
                [MW("C3H9O6P") - H2O + ADDUCT[adduct], 291, "glycerol3P - water"]
            )
            ...
            FRAGMENTS.append(
                [MW("C9H19O11P") - H2O - PROTON, 137, "glycerol-phosphoinositol - H2O"]
            )
            FRAGMENTS.append([MW("C6H13O9P") - PROTON, 7, "inositol-phosphate"])
            FRAGMENTS.append(
                [MW("C6H13O9P") - PROTON - H2O, 228, "inositol-phosphate - H2O"]
            )
            FRAGMENTS.append(
                [MW("C6H13O9P") - PROTON - H2O - H2O, 13, "inositol-phosphate - 2xH2O"]
            )
