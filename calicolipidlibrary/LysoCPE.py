    ...
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:
            if adduct == "[M+H]+":
                ...
                FRAGMENTS.append(
                    [PREC - MW("C2H10NO5P"), 1000, "NL Phosphoethanolamine"]
                )
                FRAGMENTS.append(
                    [PREC - MW("C2H10NO5P") + H2O, 92, "NL Deoxyphosphoethanolamine"]
                )
            ...
            if adduct == "[M+Na]+" or adduct == "[M+K]+":
                ...
                FRAGMENTS.append(
                    [PREC - MW("C2H7NO") + H2O, 100, "NL deoxyethanolamine"]
                )

                FRAGMENTS.append(
                    [MW("H3PO4") + ADDUCT[adduct], 600, "phosphoric acid + adduct"]
                )
                ...
                FRAGMENTS.append(
                    [
                        MW("C2H10NO5P") - 2 * H2O + ADDUCT[adduct],
                        24,
                        "doubledeoxyethanolamine phosphate",
                    ]
                )
                FRAGMENTS.append(
                    [
