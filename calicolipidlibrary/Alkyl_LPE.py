    ...
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:
            if adduct == "[M+H]+":
                ...
                FRAGMENTS.append(
                    [MW("C3H9O6P") + ADDUCT[adduct] - H2O, 31, "glycerol-P - H2O"]
                )
                FRAGMENTS.append(
                    [MW("C2H8NO4P") + ADDUCT[adduct] - H2O, 2, "ethanolamine-P - H2O"]
                )
            ...
            if adduct in ["[M+Na]+", "[M+K]+", "[M+Li]+", "[M+NH4]+"]:
                ...
                FRAGMENTS.append(
                    [PREC - MW("C2H6NO3P"), 28, "NL double deoxyethanolamine-P"]
                )
                ...
                FRAGMENTS.append(
                    [
                        ...
                        270,
                        "glycerol-P - H2O + adduct",
                    ]
                )
                FRAGMENTS.append(
                    [
                        MW("C2H8NO4P") + ADDUCT[adduct] - H2O,
                        46,
                        "double deoxyethanolamine-P + adduct",
                    ]
                )
                FRAGMENTS.append(
                    [MW("H3PO4") + ADDUCT[adduct], 37, "phosphoric acid + Adduct"]
                )
                FRAGMENTS.append(
                    [MW("C2H8NO4P") + ADDUCT[adduct], 3, "deoxyethanolamine-P + adduct"]
                )
            ...
            FRAGMENTS.append(
                [MW("C2H8NO4P") - H2O - PROTON, 10, "Phosphoethanolamine - H20"]
            )
