    ...
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:
            if adduct == "[M+H]+":
                ...
                FRAGMENTS.append(
                    [
                        MW("C2H10NO5P") - H2O + ADDUCT[adduct],
                        6,
                        "deoxyethanolamine phosphate",
                    ]
                )
                FRAGMENTS.append(
                    [PREC - MW("C2H10NO5P"), 680, "NL phosphoethanolamine"]
                )
                FRAGMENTS.append(
                    [PREC - MW("C2H10NO5P") + H2O, 1000, "NL deoxyphosphoethanolamine"]
                )

                FRAGMENTS.append(
                    [
                        NL(self.chains[1]) - H2O + MW("C2H3N") + PROTON,
                        134,
                        "Fatty amide + C2",
                    ]
                )
                ...
                FRAGMENTS.append(
                    [
                        ...
                        + PROTON,
                        455,
                        "NL phosphoethanolamine + ketene + ADDUCT",
                    ]
                )
            ...
            if adduct == "[M+Na]+" or adduct == "[M+K]+" or adduct == "[M+NH4]+":
                ...
                FRAGMENTS.append(
                    [PREC - MW("C2H7NO") + H2O, 318, "NL deoxyethanolamine"]
                )
                FRAGMENTS.append(
                    [
                        MW("C2H10NO5P") - H2O + ADDUCT[adduct],
                        235,
                        "deoxyethanolamine phosphate + Adduct",
                    ]
                )
                FRAGMENTS.append(
                    [MW("H3PO4") + ADDUCT[adduct], 189, "phosphoric acid + Adduct"]
                )
                FRAGMENTS.append([PREC - MW("C2H10NO5P"), 25, "NL phosphoethanolamine"])
                FRAGMENTS.append(
                    [PREC - MW("C2H10NO5P") + H2O, 955, "NL deoxyhosphoethanolamine"]
                )

                FRAGMENTS.append(
                    [
                        PREC - MW("C2H10NO5P") - (ADDUCT[adduct] - PROTON),
                        57,
                        "NL phosphoethanolamine + adduct",
                    ]
                )
                FRAGMENTS.append(
                    [
                        PREC - MW("C2H10NO5P") - (ADDUCT[adduct] - PROTON) + H2O,
                        25,
                        "NL Deoxyphosphoethanolamine + adduct",
                    ]
                )
                FRAGMENTS.append(
                    [
            ...
            chain = str(i + 1)
            FRAGMENTS.append(
                [PREC - NL(self.chains[i]) + H2O, 7, "NL ketene + 2x water"]
            )
