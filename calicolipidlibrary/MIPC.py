...
class MIPC(PhytoSphingoLipid):
    def theoreticalDigest(self):
        ...
        if adduct in NEG_ADDUCTS:
            ...
            FRAGMENTS.append(
                [MW("C6H13O9P") - PROTON - H2O, 25, "inositolphosphate ion-H2O"]
            )
            FRAGMENTS.append(
                [MW("C6H13O9P") - PROTON - H2O - H2O, 8, "inositolphosphate ion-2xH2O"]
            )
            FRAGMENTS.append(
                [
                    PREC - ADDUCT[adduct] - MW("C12H20O10") - PROTON - H2O,
                    26,
                    "Ceramide-P - H2O ",
                ]
            )
            FRAGMENTS.append(
                [PREC - ADDUCT[adduct] - MW("C12H20O10") - PROTON, 10, "Ceramide-P"]
            )
            # LCB fragments:
