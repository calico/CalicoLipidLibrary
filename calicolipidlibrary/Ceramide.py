        ...
        if adduct in POS_ADDUCTS:
            if adduct == "[M+H]+":
                if self.chains[0][1] == 0:  # for sphinganines
                    FRAGMENTS.append(
                        [PREC - NL(self.chains[1]) + H2O, 92, " NL sn2 ketene"]
                    )  # unique to sphinganine
                    ...
                    FRAGMENTS.append(
                        [PREC - NL(self.chains[1]) - H2O, 278, "pre-sn2-H2O"]
                    )
                    FRAGMENTS.append(
                        [PREC - NL(self.chains[1]) - MW("CH2O"), 37, "pre-sn2-CH2O"]
                    )
                    FRAGMENTS.append(
                        [
                    ...
                    FRAGMENTS.append(
                        [NL(self.chains[1]) - H2O + PROTON, 3, "sn2 acylium ion"]
                    )
                    ...
                    FRAGMENTS.append(
                        [PREC - NL(self.chains[1]) - H2O, 1000, "pre-sn2-H2O"]
                    )
                    FRAGMENTS.append(
                        [PREC - NL(self.chains[1]) - MW("CH2O"), 101, "pre-sn2-CH2O"]
                    )
                    FRAGMENTS.append(
                        [
                            NL(self.chains[1]) - H2O + MW("NH3") + PROTON,
                    ...
                    FRAGMENTS.append(
                        [NL(self.chains[1]) - H2O + PROTON, 1, "sn2 acylium ion"]
                    )
            ...
            if adduct in ["[M+Li]+", "[M+Na]+", "[M+K]+", "[M+NH4]+"]:
                ...
                FRAGMENTS.append(
                    [
                        NL(self.chains[1]) - H2O + MW("NH") + ADDUCT[adduct],
                        1000,
                        "sn2 fatty amide + adduct",
                    ]
                )
                FRAGMENTS.append(
                    [NL(self.chains[1]) - H2O + PROTON, 1000, "sn2 acylium ion"]
                )
                FRAGMENTS.append(
                    [
                        NL(self.chains[1]) - H2O - H2O + PROTON,
                        1000,
                        "sn2 acylium ion - H2O",
                    ]
                )
                FRAGMENTS.append(
                    [PREC - NL(self.chains[1]) + H2O, 1000, "pre-sn2+H2O+ADDUCT"]
                )
            ...
            FRAGMENTS.append(
                [
                    PREC - ADDUCT[adduct] - NL(self.chains[1]) + H2O - PROTON,
                    90,
                    "LCB M-H",
                ]
            )
            ...
            FRAGMENTS.append(
                [
                    NL(self.chains[1]) - H2O + MW("C2H7ON") - PROTON,
                    13,
                    "N-acyl-ethanolamine - H",
                ]
            )
            FRAGMENTS.append(
                [
                    NL(self.chains[1]) - H2O + MW("C2H5ON") - PROTON,
                    117,
                    "N-acyl-ethanolamine - H2 - H",
                ]
            )
            FRAGMENTS.append(
                [
            ...
            FRAGMENTS.append(
                [NL(self.chains[1]) - H2O + MW("NH3") - PROTON, 105, "Fatty Amide - H"]
            )
            FRAGMENTS.append(
                [NL(self.chains[1]) - H2O - PROTON, 219, "Fatty Amide - NH3 - H"]
            )
            ...
            if self.chains[0][1] == 0:
                FRAGMENTS.append(
                    [PREC - ADDUCT[adduct] - PROTON - MW("CH4O2"), 223, "pre-COH2-H2O"]
                )
                FRAGMENTS.append(
                    [PREC - ADDUCT[adduct] - PROTON - MW("CH4O"), 200, "pre-COH4"]
                )

                FRAGMENTS.append(
                    [PREC - ADDUCT[adduct] - PROTON - MW("CH2O"), 2, "pre-COH2"]
                )

            if self.chains[0][1] == 1:
                FRAGMENTS.append(
                    [PREC - ADDUCT[adduct] - PROTON - MW("CH4O2"), 74, "pre-COH2-H2O"]
                )
                FRAGMENTS.append(
                    [PREC - ADDUCT[adduct] - PROTON - MW("CH4O"), 67, "pre-COH4"]
                )

                FRAGMENTS.append(
                    [PREC - ADDUCT[adduct] - PROTON - MW("CH2O"), 110, "pre-COH2"]
                )

            if self.chains[0][1] == 2:
                FRAGMENTS.append(
                    [PREC - ADDUCT[adduct] - PROTON - MW("CH4O2"), 105, "pre-COH2-H2O"]
                )
                FRAGMENTS.append(
                    [PREC - ADDUCT[adduct] - PROTON - MW("CH4O"), 19, "pre-COH4"]
                )
