    ...
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:
            if adduct == "[M+H]+":
                ...
                FRAGMENTS.append(
                    [
                        PREC - MW("C11H19NO10") - MW("C6H10O5"),
                        1000,
                        "pre - N-Gc-Neuraminic Acid - glucose",
                    ]
                )
                FRAGMENTS.append(
                    [
                        PREC - MW("C11H19NO10") - 2 * MW("C6H10O5"),
                        1000,
                        "pre - N-Gc-Neuraminic Acid - glucose - galactose",
                    ]
                )
                FRAGMENTS.append(
                    [
                        PREC - MW("C11H19NO10") - 2 * MW("C6H10O5") - H2O,
                        1000,
                        "pre - N-Gc-Neuraminic Acid - glucose - galactose - water",
                    ]
                )
                FRAGMENTS.append(
                    [
            ...
            if adduct == "[M+Na]+" or adduct == "[M+K]+":
                ...
                FRAGMENTS.append(
                    [
                        PREC - MW("C11H19NO10") - MW("C6H10O5") + H2O,
                        1000,
                        "pre - N-Gc-Neuraminic Acid - glucose",
                    ]
                )
            ...
            if adduct == "[M-H]-":  # by analogy from AcGM3 standard
                ...
                FRAGMENTS.append(
                    [MW("C11H19NO10") - PROTON, 2, "N-Ac-Neuraminic Acid "]
                )
                FRAGMENTS.append(
                    [MW("C11H19NO10") - H2O - PROTON, 837, "deoxy-N-Ac-Neuraminic Acid"]
                )
                ...
                FRAGMENTS.append(
                    [PREC - MW("C11H19NO10") + H2O, 14, "NL - N-Ac-Neuraminic Acid"]
                )
                FRAGMENTS.append(
                    [
                        PREC - MW("C11H19NO10") - MW("C6H10O5") + H2O,
                ...
                FRAGMENTS.append(
                    [PREC - MW("C11H19NO10") - 2 * MW("C6H10O5") + H2O, 21, "Ceramide"]
                )
