    ...
    def theoreticalDigest(self):
        ...
        if adduct in NEG_ADDUCTS:
            ...
            if adduct == "[M-H]-":
                ...
                FRAGMENTS.append(
                    [MW("C3H9O6P") - H2O - PROTON, 1000, "Glycerol-P - water"]
                )
                ...
                FRAGMENTS.append(
                    [
                        PREC - NL(self.chains[0]) - NL(self.chains[1]) - MW("C3H9O6P"),
                        1000,
                        "NL glycerol-P + sn1+sn2",
                    ]
                )
                FRAGMENTS.append(
                    [
                        PREC - NL(self.chains[2]) - MW("C3H9O6P"),
                        1000,
                        "NL glycerol-P + sn3+sn4",
                    ]
                )
                ...
                FRAGMENTS.append(
                    [
                        NL(self.chains[2]) + +MW("C3H9O6P") - PROTON,
                        1000,
                        "glycerol-P + sn3+sn4",
                    ]
                )
                ...
                FRAGMENTS.append(
                    [
                        PREC - NL(self.chains[0]) - NL(self.chains[1]) - MW("C3H8O3"),
                        1000,
                        "NL glycerol + sn1+sn2",
                    ]
                )
                FRAGMENTS.append(
                    [
                        PREC - NL(self.chains[2]) - MW("C3H8O3"),
                        1000,
                        "NL glycerol + sn3+sn4",
                    ]
                )
