    ...
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:
            if adduct == "[M+H]+":
                ...
                FRAGMENTS.append(
                    [MW("C3H9O6P") + ADDUCT[adduct], 18, "glycerol-P + adduct"]
                )
                FRAGMENTS.append(
                    [
                ...
                FRAGMENTS.append(
                    [MW("H3O4P") + ADDUCT[adduct], 25, "phosphoric acid + adduct"]
                )

                FRAGMENTS.append(
                    [NL(self.chains[0]) - H2O + PROTON, 26, "sn1 acylium ion"]
                )
            ...
            if adduct in ["[M+Na]+", "[M+K]+", "[M+Li]+", "[M+NH4]+"]:
                ...
                FRAGMENTS.append(
                    [MW("C3H9O6P") + ADDUCT[adduct], 281, "glycerol-P + adduct"]
                )
                FRAGMENTS.append(
                    [MW("C6H15O8P") + ADDUCT[adduct], 4, "glycerol-P-glycerol + adduct"]
                )
                ...
                FRAGMENTS.append(
                    [MW("C3H8O3") + ADDUCT[adduct], 14, "glycerol + adduct"]
                )

                FRAGMENTS.append(
                    [NL(self.chains[0]) - H2O + PROTON, 8, "sn1 acylium ion"]
                )
                FRAGMENTS.append([PREC - NL(self.chains[0]), 251, "NL sn1"])
                FRAGMENTS.append(
                    [MW("H3O4P") + ADDUCT[adduct], 9, "phosphoric acid + adduct"]
                )
            ...
            FRAGMENTS.append(
                [PREC - MW("C3H7O3") + H2O - PROTON, 2, "NL deoxyglycerol"]
            )
