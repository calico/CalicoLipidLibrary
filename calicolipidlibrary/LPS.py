    ...
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:
            if adduct == "[M+H]+":
                ...
                FRAGMENTS.append(
                    [MW("C3H8NO6P") + ADDUCT[adduct], 6, "phosphoserine"]
                )  # Ser
                FRAGMENTS.append([MW("C3H7NO3") + ADDUCT[adduct], 178, "Serine"])  # Ser
                FRAGMENTS.append(
                    [MW("C3H7NO3") + ADDUCT[adduct] - H2O, 215, "Serine - water"]
                )  # Ser
                FRAGMENTS.append(
                    [MW("C3H9O6P") + ADDUCT[adduct], 43, "Glycerol-P"]
                )  # Ser  C3H9O6P
                FRAGMENTS.append(
                    [MW("C3H9O6P") + ADDUCT[adduct] - H2O, 151, "Glycerol-P - water"]
                )

                FRAGMENTS.append([PREC - MW("C3H7NO3"), 309, "NL serine"])  # C3H8NO6P

                FRAGMENTS.append(
                    [MW("H3PO4") + ADDUCT[adduct], 141, "phosphoric acid + Adduct"]
                )  # Ser
                FRAGMENTS.append([PREC - NL(self.chains[0]) + H2O, 18, "NL sn1 ketene"])
                FRAGMENTS.append([PREC - NL(self.chains[0]), 10, "NL sn1"])
                FRAGMENTS.append(
                    [NL(self.chains[0]) - H2O + ADDUCT[adduct], 99, "sn1 acylium ion"]
                )
                FRAGMENTS.append(
                    [
                        NL(self.chains[0]) - H2O - H2O + ADDUCT[adduct],
                        25,
                        "sn1 acylium ion - H2O",
                    ]
                )
                FRAGMENTS.append(
                    [
                        NL(self.chains[0]) - H2O + MW("C3H5NO2") + ADDUCT[adduct],
                        85,
                        "sn1 + serine",
                    ]
                )
            ...
            if adduct in ["[M+Na]+", "[M+K]+", "[M+Li]+", "[M+NH4]+"]:
                ...
                FRAGMENTS.append(
                    [PREC - MW("C3H8NO6P"), 16, "NL phosphoserine"]
                )  # C3H8NO6P
                FRAGMENTS.append(
                    [
                        PREC - MW("C3H8NO6P") - ADDUCT[adduct] + PROTON,
                        439,
                        "NL phosphoserine + adduct",
                    ]
                )  # C3H8NO6P

                FRAGMENTS.append(
                    [PREC - MW("C3H8NO6P") + H2O, 49, "NL deoxyphosphoserine"]
                )  # C3H8NO6P
                ...
                FRAGMENTS.append(
                    [MW("C3H8NO6P") + ADDUCT[adduct], 207, "phosphoserine + Adduct"]
                )  # Ser
                FRAGMENTS.append(
                    [MW("C3H7NO3") + ADDUCT[adduct], 6, "Serine + Adduct"]
                )  # Ser
                FRAGMENTS.append(
                    [
                ...
                FRAGMENTS.append(
                    [MW("C3H9O6P") + ADDUCT[adduct], 79, "Glycerol-P + Adduct"]
                )  # Ser  C3H9O6P
                FRAGMENTS.append(
                    [
                        MW("C3H9O6P") + ADDUCT[adduct] - H2O,
                        45,
                ...
                FRAGMENTS.append([PREC - MW("C3H7NO3"), 309, "NL serine"])  # C3H8NO6P
                FRAGMENTS.append(
                    [PREC - MW("C3H5NO2"), 887, "NL deoxyserine"]
                )  # C3H8NO6P
