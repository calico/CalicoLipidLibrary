    ...
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:
            if adduct == "[M+H]+":
                ...
                FRAGMENTS.append(
                    [MW("C11H19NO9") - H2O + PROTON, 514, "deoxy-N-Ac-Neuraminic Acid"]
                )
                FRAGMENTS.append(
                    [
                ...
                FRAGMENTS.append(
                    [MW("C8H15NO6") - H2O + PROTON, 425, "deoxy-N-Ac-glucosamine"]
                )
            ...
            if adduct == "[M+2H]2+":
                ...
                FRAGMENTS.append(
                    [SINGLE - MW("C11H19NO9"), 2, "NL N-Ac-Neuraminic Acid"]
                )
                ...
                FRAGMENTS.append(
                    [
                        SINGLE - MW("C11H19NO9") - MW("C6H12O6") + H2O,
                        6,
                        "NL deoxy-N-Ac-Neuraminic Acid + deoxygalactose",
                    ]
                )
                FRAGMENTS.append(
                    [
                ...
                FRAGMENTS.append(
                    [
                        SINGLE - 3 * MW("C11H19NO9") + 2 * H2O,
                        14,
                        "NL N-Ac-Neuraminic Acid + 2x deoxy-N-acetyl-Neuraminic Acid",
                    ]
                )
                FRAGMENTS.append(
                    [
                ...
                FRAGMENTS.append(
                    [
                        ...
                        + 4 * H2O,
                        59,
                        "NL N-Ac-Neuaraminic Acid + 3x deoxy-N-Ac-Neuraminic Acid + Galactose + N-Ac-Galactosamine",
                    ]
                )
                FRAGMENTS.append(
                    [
                        ...
                        + 5 * H2O,
                        68,
                        "NL N-Ac-Neuaraminic Acid + 3x deoxy-N-Ac-Neuraminic Acid + 2*Galactose + N-Ac-Galactosamine",
                    ]
                )
                ...
                FRAGMENTS.append(
                    [MW("C8H15NO6") - H2O + PROTON, 286, "deoxy-N-Ac-glucosamine"]
                )
                FRAGMENTS.append(
                    [
                ...
                FRAGMENTS.append(
                    [MW("C11H19NO9") - H2O + PROTON, 404, "deoxy-N-Ac-Neuraminic Acid"]
                )
                FRAGMENTS.append(
                    [
                        MW("C11H19NO9") - 2 * H2O + PROTON,
        ...
        if adduct == "[M+Na]+" or adduct == "[M+K]+":
            ...
            FRAGMENTS.append(
                [PREC - MW("C11H19NO9") + H2O, 135, "NL deoxy-N-Ac-Neuraminic Acid"]
            )
            FRAGMENTS.append(
                [
            ...
            FRAGMENTS.append(
                [
                    PREC - 2 * MW("C11H19NO9") + 2 * H2O - MW("CO2"),
                    38,
            ...
            if adduct == "[M-2H]2-":
                ...
                FRAGMENTS.append(
                    [SINGLE - MW("C11H19NO9"), 8, "NL N-Ac-Neuraminic Acid"]
                )
                FRAGMENTS.append(
                    [
                        SINGLE - MW("C11H19NO9") - MW("CO2") + H2O,
                        24,
                ...
                FRAGMENTS.append(
                    [
                        SINGLE - 3 * MW("C11H19NO9") - MW("C6H10O5") + 3 * H2O,
                        4,
                        "NL 3x deoxy-N-Ac-Neuraminic Acid + galactose",
                    ]
                )
