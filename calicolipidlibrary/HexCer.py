        ...
        if adduct in POS_ADDUCTS:
            if adduct == "[M+H]+":
                ...
                if self.chains[0][1] != 0:
                    ...
                    FRAGMENTS.append(
                        [PREC - MW("C6H12O6") - H2O, 65, "NL hexose  + water"]
                    )
                    FRAGMENTS.append(
                        [
                            PREC - MW("C6H12O6") - NL(self.chains[1]) + H2O,
                            95,
                            "NL hexose + acyl ketene",
                        ]
                    )
                    FRAGMENTS.append(
                        [
                            PREC - MW("C6H12O6") - NL(self.chains[1]),
                            1000,
                            "NL hexose + acyl ketene + water",
                        ]
                    )
                    FRAGMENTS.append(
                        [
                            ...
                            - MW("CH2O"),
                            93,
                            "NL hexose + acyl ketene + water + CH2O)",
                        ]
                    )
                    FRAGMENTS.append(
                        [
                    ...
                    if self.chains[1][2] > 0:
                        FRAGMENTS.append(
                            [
                                NL(self.chains[1]) - H2O - H2O + MW("NH3") + PROTON,
                                20,
                                "fatty amide - water",
                            ]
                        )  # guess, not from spectra
                else:  # for dihydrosphingosine backbones
                    FRAGMENTS.append([PREC - H2O, 2, "NL H2O"])
                    FRAGMENTS.append(
                        [PREC - MW("C6H12O6") + H2O, 337, "NL deoxyhexose"]
                    )
                    FRAGMENTS.append([PREC - MW("C6H12O6"), 1000, "NL hexose"])
                    FRAGMENTS.append(
                        [PREC - MW("C6H12O6") - H2O, 59, "NL hexose  + water"]
                    )
                    FRAGMENTS.append(
                        [
                            PREC - MW("C6H12O6") - NL(self.chains[1]) + H2O,
                            391,
                            "NL deoxyhexose + acyl ketene",
                        ]
                    )
                    FRAGMENTS.append(
                        [
                            PREC - MW("C6H12O6") - NL(self.chains[1]) + 2 * H2O,
                            81,
                            "NL double-deoxyhexose + acyl ketene",
                        ]
                    )
            ...
            if adduct in ["[M+Na]+", "[M+K]+", "[M+Li]+", "[M+NH4]+"]:
                ...
                FRAGMENTS.append(
                    [PREC - MW("C6H12O6") - MW("COH2"), 1000, "NL hexose + H2CO"]
                )
                FRAGMENTS.append(
                    [
                        PREC - MW("C6H12O6") - NL(self.chains[1]),
                ...
                FRAGMENTS.append(
                    [MW("C6H12O6") + ADDUCT[adduct], 1000, "hexose + adduct"]
                )
            ...
            FRAGMENTS.append(
                [
                    PREC - ADDUCT[adduct] - MW("C6H10O5") - PROTON,
                    766,
                    "NL deoxyhexose + adduct",
                ]
            )
            FRAGMENTS.append(
                [
            ...
            FRAGMENTS.append(
                [
                    PREC - ADDUCT[adduct] - MW("C7H12O6") - PROTON,
                    41,
                    "NL C7H12O6 + adduct",
                ]
            )
            FRAGMENTS.append(
                [
                    PREC - ADDUCT[adduct] - MW("C7H14O6") - PROTON,
                    22,
                    "NL C7H14O6 + adduct",
                ]
            )
            FRAGMENTS.append(
                [
                    PREC - ADDUCT[adduct] - MW("C7H12O6") - H2O - PROTON,
                    45,
                    "NL C7H12O6 + H2O + adduct",
                ]
            )
            ...
            FRAGMENTS.append(
                [NL(self.chains[1]) - H2O + MW("NH3") - PROTON, 84, "sn2 fatty amide"]
            )
            ...
            FRAGMENTS.append(
                [
                    NL(self.chains[1]) - H2O + MW("NH3") + MW("C2H2O") - PROTON,
                    65,
                    "sn2 fatty amide + C2H2O",
                ]
            )
            ...
            if self.chains[1][2] == 1:
                ...
                )  # intensity a guess, not from spectra
                FRAGMENTS.append(
                    [
                        NL(self.chains[1]) - H2O + MW("H2") - PROTON,
                        10,
                        "acyl ketene + H2",
                    ]
                )  # intensity a guess, not from spectra
            ...
            if self.chains[0][2] == 2:
                ...
                )  # intensity a guess, not grom spectra
