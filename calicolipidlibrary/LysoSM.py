        ...
        if adduct in POS_ADDUCTS:
            if adduct == "[M+H]+":
                ...
                if self.chains[0][1] == 0:
                    FRAGMENTS.append(
                        [PREC - MW("C5H14NO4P") - H2O, 11, "NL Phosphocholine + water"]
                    )
                    FRAGMENTS.append([PREC - MW("C5H14NO4P"), 6, "NL Phosphocholine"])
                else:
                    FRAGMENTS.append(
                        [PREC - MW("C5H14NO4P") - H2O, 20, "NL Phosphocholine + water"]
                    )
            ...
            if adduct == "[M+Na]+" or adduct == "[M+K]+" or adduct == "[M+NH4]+":
                ...
                FRAGMENTS.append(
                    [MW("C2H5O4P") + ADDUCT[adduct], 920, "C2H5O4P + Adduct"]
                )
            ...
            FRAGMENTS.append(
                [PREC - ADDUCT[adduct] - PROTON - MW("CH3"), 1000, "pre-adduct-CH3"]
            )
