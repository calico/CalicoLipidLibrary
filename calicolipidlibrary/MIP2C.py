...
class MIP2C(SphingoLipid):
    def theoreticalDigest(self):
        ...
        if adduct in NEG_ADDUCTS:
            ...
            FRAGMENTS.append(
                [MW("C6H13O9P") - PROTON - H2O, 1000, "phosphoinositol ion-H2O"]
            )
            FRAGMENTS.append(
                [MW("C6H13O9P") - PROTON - H2O - H2O, 1000, "phosphoinositol ion-2xH2O"]
            )

            FRAGMENTS.append(
                [
                    PREC - ADDUCT[adduct] - MW("C18H31O18P") - PROTON - H2O,
                    1000,
                    "Ceramide-P - H2O ",
                ]
            )
            FRAGMENTS.append(
                [PREC - ADDUCT[adduct] - MW("C18H31O18P") - PROTON, 1000, "Ceramide-P"]
            )
            FRAGMENTS.append(
                [
                    PREC - ADDUCT[adduct] - MW("C18H31O18P") - MW("PO3H") - PROTON,
                    1000,
                    "Ceramide",
                ]
            )
            ...
            FRAGMENTS.append(
                [NL(self.chains[1]) - PROTON, 1000, "fatty acid"]
            )  # seems wrong?
