...
# 		
				...
				for i in [1]:
					...
					FRAGMENTS.append( [PREC - MW("C3H5NO2")-NL(self.chains[i])+H2O, 1000, "NL (Serine + sn" + chain +"ketene)"] )
					FRAGMENTS.append( [PREC - MW("C3H5NO2")-NL(self.chains[i]), 1000, "NL Serine + sn" + chain+")"] )
