    ...
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:
            if adduct == "[M+H]+":
                ...
                FRAGMENTS.append(
                    [MW("C9H13N3O5") - 2 * H2O + PROTON, 81, "deoxyCytidine - water "]
                )
            ...
            if adduct == "[M+Na]+" or adduct == "[M+K]+":
                ...
                FRAGMENTS.append(
                    [MW("C4H5N3O") + ADDUCT[adduct], 140, "cytosine + adduct"]
                )
                FRAGMENTS.append([MW("C9H13N3O5") - H2O + PROTON, 81, "deoxycytidine"])
                FRAGMENTS.append(
                    [MW("P2O7H4") + ADDUCT[adduct], 325, "pyrophosphate + Adduct"]
                )
                FRAGMENTS.append(
                    [
                        MW("C5H12O11P2") + ADDUCT[adduct] - 2 * H2O,
                        289,
                        "ribose-pyrophosphate - 2x water",
                    ]
                )
                FRAGMENTS.append(
                    [
                        MW("C5H12O11P2") + ADDUCT[adduct] - H2O,
                        9,
                        "ribose-pyrophosphate -  water",
                    ]
                )
                FRAGMENTS.append(
                    [
                        MW("C5H11O8P") + ADDUCT[adduct] - 2 * H2O,
                        114,
                        "ribose-phosphate -  2x water",
                    ]
                )
                FRAGMENTS.append(
                    [
                        MW("C5H11O8P") + ADDUCT[adduct] - 3 * H2O,
                        30,
                        "ribose-phosphate -  3x water",
                    ]
                )

                FRAGMENTS.append(
                    [
                        PREC - MW("C9H15N3O11P2") - ADDUCT[adduct] + PROTON,
                        304,
                        "NL deoxyCDP + adduct",
                    ]
                )
                ...
                FRAGMENTS.append(
                    [MW("C9H15N3O11P2") + ADDUCT[adduct], 1000, "deoxyCDP + adduct"]
                )
                FRAGMENTS.append(
                    [MW("C9H14N3O8P") + ADDUCT[adduct], 157, "deoxyCMP + adduct"]
                )
                FRAGMENTS.append(
                    [
                        MW("C9H14N3O8P") - H2O + ADDUCT[adduct],
                        99,
                        "deoxyCMP - water + adduct",
                    ]
                )
                ...
                for i in range(0, len(self.chains)):
                    ...
                    FRAGMENTS.append(
                        [
                            NL(self.chains[i]) + MW("C3H4O") + PROTON,
                            4,
            ...
            FRAGMENTS.append(
                [MW("P2O7H4") - H2O - PROTON, 113, "pyrophosphate - water"]
            )
            ...
            for i in range(0, len(self.chains)):
                ...
                FRAGMENTS.append(
                    [
                        PREC - NL(self.chains[i]) - MW("C9H13N3O5"),
                        18,
                        "NL sn" + chain + " + Cytidine",
                    ]
                )
                FRAGMENTS.append(
                    [
                        PREC - NL(self.chains[i]) - MW("C9H13N3O5") + H2O,
                        6,
                        "NL sn" + chain + " + deoxycytidine",
                    ]
                )
