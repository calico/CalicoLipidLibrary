        ...
        if adduct in POS_ADDUCTS:
            if adduct == "[M+H]+":
                ...
                for i in range(0, len(self.chains)):
                    ...
                    FRAGMENTS.append(
                        [
                            NL(self.chains[i]) - 2 * H2O + PROTON,
                            53,
                            "sn" + chain + " acylium - water",
                        ]
                    )

            if adduct in ["[M+Na]+", "[M+K]+", "[M+Li]+", "[M+NH4]+"]:
                FRAGMENTS.append(
                    [MW("C3H8O3") - H2O + ADDUCT[adduct], 37, "deoxyglycerol + adduct"]
                )
                FRAGMENTS.append(
                    [MW("C3H8O3") + ADDUCT[adduct], 37, "glycerol + adduct"]
                )

                FRAGMENTS.append([PREC, 1000, "precursor"])
                FRAGMENTS.append(
                    [PREC - ADDUCT[adduct] - H2O + PROTON, 1000, "NL adduct + water"]
                )
                FRAGMENTS.append(
                    [
                        PREC - ADDUCT[adduct] - H2O - H2O + PROTON,
                        1000,
                        "NL adduct + 2*water",
                    ]
                )
                ...
                for i in range(0, len(self.chains)):
                    ...
                    FRAGMENTS.append(
                        [
                            ...
                            1000,
                            "sn" + chain + " + glycerol - water",
                        ]
                    )
                    FRAGMENTS.append(
                        [
                            NL(self.chains[i]) + PROTON + MW("C3H6O2"),
                            1000,
                            "sn" + chain + " + glycerol",
                        ]
                    )
