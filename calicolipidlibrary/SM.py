    ...
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:
            ...
            if adduct in ["[M+Na]+", "[M+K]+", "[M+Li]+", "[M+NH4]+"]:
                ...
                FRAGMENTS.append(
                    [MW("C5H14NO4P") + ADDUCT[adduct], 2, "Phospocholine + ADDUCT"]
                )
                FRAGMENTS.append(
                    [MW("C2H5O4P") + ADDUCT[adduct], 250, "C2H5O4P + adduct"]
                )
                ...
                FRAGMENTS.append(
                    [
                        PREC - MW("C5H14NO4P") - (ADDUCT[adduct] - PROTON + H2O),
                        29,
                        "NL DeoxyPhosphoCholine+ adduct",
                    ]
                )
                FRAGMENTS.append(
                    [
            ...
            FRAGMENTS.append(
                [PREC - ADDUCT[adduct] - MW("CH3"), 1000, "pre-adduct-CH3"]
            )
            FRAGMENTS.append([MW("HPO3") - PROTON, 510, "PO3-"])
            FRAGMENTS.append(
                [MW("C5H15NO4P") - PROTON - MW("CH3"), 507, "phosphocholine - CH3"]
            )
