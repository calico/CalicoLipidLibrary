    ...
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:
            if adduct == "[M+H]+":
                ...
                FRAGMENTS.append(
                    [PREC - MW("C12H22O11") - H2O, 1000, "NL 2x galactose + water"]
                )
                FRAGMENTS.append([PREC - MW("C18H32O16"), 1000, "Ceramide"])
                FRAGMENTS.append(
                    [PREC - MW("C18H32O16") - H2O, 1000, "Ceramide - water"]
                )
                FRAGMENTS.append(
                    [
                        PREC - MW("C18H32O16") - NL(self.chains[1]) + H2O,
                        1000,
                        "sphingobase",
                    ]
                )
                FRAGMENTS.append(
                    [
                        PREC - MW("C18H32O16") - NL(self.chains[1]),
                        1000,
                        "sphingobase - water",
                    ]
                )
                FRAGMENTS.append(
                    [
                        PREC - MW("C18H32O16") - NL(self.chains[1]) + H2O - MW("CH2O"),
                        1000,
                        "sphingobase - CH2O",
                    ]
                )
            ...
            if adduct == "[M+Na]+" or adduct == "[M+K]+" or adduct == ["M+NH4]+"]:
                FRAGMENTS.append([PREC, 1000, "precursor"])
                FRAGMENTS.append(
                    [PREC - MW("C6H12O6") + H2O, 1000, "NL deoxygalactose"]
                )
                FRAGMENTS.append(
                    [
                        PREC
                        ...
                        + PROTON,
                        10,
                        "N'': NL 3x hexose + acyl ketene + water + ADDUCT",
                    ]
                )
                FRAGMENTS.append(
                    [
                        MW("C18H32O16") + ADDUCT[adduct],
                        10,
                        "2x galactose + glucose + Adduct",
                    ]
                )
                FRAGMENTS.append(
                    [
                        MW("C18H32O16") - H2O + ADDUCT[adduct],
                        10,
                        "2x galactose + deoxyglucose + Adduct",
                    ]
                )
            ...
            if adduct == "[M-H]-":
                ...
                FRAGMENTS.append(
                    [PREC - MW("C18H32O16"), 1000, "NL 2x galactose + deoxyglucose"]
                )
                FRAGMENTS.append(
                    [PREC - MW("C18H32O16"), 1000, "NL 2x galactose + deoxyglucose"]
                )
                ...
                FRAGMENTS.append(
                    [
                        MW("C18H32O16") - H2O - PROTON,
                        1000,
                        "2x galactose + deoxyglucose",
                    ]
                )
                FRAGMENTS.append(
                    [MW("C18H32O16") - PROTON, 1000, "2x galactose + glucose"]
                )
