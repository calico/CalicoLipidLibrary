    ...
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:
            ...
            if adduct == "[M+H]+":
                ...
                FRAGMENTS.append(
                    [PREC - MW("C11H19NO9"), 65, "NL N-Ac-Neuraminic Acid"]
                )
                FRAGMENTS.append(
                    [
                        PREC - MW("C11H19NO9") - MW("C6H10O5"),
                        114,
                        "NL N-Ac-Neuraminic Acid + galactose",
                    ]
                )
                FRAGMENTS.append(
                    [PREC - MW("C11H19NO9") - 2 * MW("C6H10O5"), 409, "Ceramide"]
                )
                FRAGMENTS.append(
                    [
                        PREC - MW("C11H19NO9") - 2 * MW("C6H10O5") - H2O,
                        97,
                        "Ceramide - water",
                    ]
                )
                ...
                FRAGMENTS.append(
                    [
                        PREC - MW("C11H19NO9") - 2 * MW("C6H10O5") - NL(self.chains[1]),
                        1000,
                        "LCB - water",
                    ]
                )
                ...
                FRAGMENTS.append(
                    [NL(self.chains[1]) - H2O + MW("NH3") + PROTON, 22, "fatty amide"]
                )

                FRAGMENTS.append(
                    [MW("C11H19NO9") - H2O + PROTON, 38, "deoxy-N-Ac-Neuraminic Acid"]
                )
                FRAGMENTS.append(
                    [
            ...
            if adduct == "[M-H]-":
                ...
                FRAGMENTS.append(
                    [MW("C11H19NO9") - H2O - PROTON, 837, "deoxy-N-Ac-Neuraminic Acid"]
                )
                ...
                FRAGMENTS.append(
                    [PREC - MW("C11H19NO9") + H2O, 14, "NL - N-Ac-Neuraminic Acid"]
                )
                FRAGMENTS.append(
                    [
                ...
                FRAGMENTS.append(
                    [PREC - MW("C11H19NO9") - 2 * MW("C6H10O5") + H2O, 21, "Ceramide"]
                )
