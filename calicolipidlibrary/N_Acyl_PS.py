...
class N_Acyl_PS(NAcylGPL):
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:  # NOt done at all
            FRAGMENTS.append(
                [
                    PREC - (NL(self.chains[2]) - MW("O") + MW("NH") + MW("C3H5O6P")),
                    1000,
                    "NL phosphoserine + Amide",
                ]
            )  # C3H8NO6P
            FRAGMENTS.append(
                [
            ...
            if adduct == "[M+H]+":
                ...
                FRAGMENTS.append(
                    [MW("C3H7NO3") + ADDUCT[adduct], 1000, "Serine"]
                )  # Ser
                FRAGMENTS.append(
                    [MW("C3H7NO3") + ADDUCT[adduct] - H2O, 1000, "Serine - water"]
                )  # Ser
                FRAGMENTS.append(
                    [MW("C3H9O6P") + ADDUCT[adduct] - H2O, 1000, "Glycerol-P - water"]
                )
            ...
            if adduct == "[M+Na]+" or adduct == "[M+NH4]+" or adduct == "[M+K]+":
                FRAGMENTS.append(
                    [
                        PREC
                        - (NL(self.chains[2]) - MW("O") + MW("NH") + MW("C3H5O6P"))
                        - ADDUCT[adduct]
                        + PROTON,
                        1000,
                        "NL phosphoserine + Amide - adduct",
                    ]
                )  # C3H8NO6P
                FRAGMENTS.append(
                    [
                ...
                FRAGMENTS.append(
                    [
                        NL(self.chains[2]) - MW("O") + MW("NH") + MW("C3H2O2") + PROTON,
                        1000,
                        "Serine+FA + proton",
                    ]
                )
                FRAGMENTS.append(
                    [
                        PREC - (NL(self.chains[2]) - MW("O") + MW("NH") + MW("C3H2O2")),
                        1000,
                        "NL Serine+FA",
                    ]
                )
            ...
            FRAGMENTS.append(
                [
                    PREC - (NL(self.chains[2]) - MW("O") + MW("NH") + MW("C3H4O2")),
                    1000,
                    "NL Serine+FA",
                ]
            )
            ...
            for i in [0, 1]:
                ...
                FRAGMENTS.append(
                    [
                        NL(self.chains[i]) + MW("C3H9O6P") - H2O - PROTON,
                        1000,
                        "sn" + chain + " Glycerol-P",
                    ]
                )
                FRAGMENTS.append(
                    [
                        NL(self.chains[i]) + MW("C3H9O6P") - 2 * H2O - PROTON,
                        1000,
                        "sn" + chain + " Glycerol-P-H2O",
                    ]
                )
