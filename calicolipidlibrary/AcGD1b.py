    ...
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:
            if adduct == "[M+H]+":
                ...
                FRAGMENTS.append(
                    [PREC - MW("C11H19NO9"), 23, "NL N-Ac-Neuraminic Acid"]
                )
                FRAGMENTS.append(
                    [
                ...
                FRAGMENTS.append(
                    [MW("C11H19NO9") - H2O + PROTON, 413, "deoxy-N-Ac-Neuraminic Acid"]
                )
                FRAGMENTS.append(
                    [
                ...
                FRAGMENTS.append(
                    [MW("C8H15NO6") - H2O + PROTON, 851, "deoxy-N-Ac-glucosamine"]
                )
                FRAGMENTS.append(
                    [
        ...
        if adduct == "[M+2H]2+":
            ...
            FRAGMENTS.append(
                [
                    SINGLE - MW("C6H12O6") - MW("C8H15NO6") + H2O,
                    8,
                    "NL deoxygalactose + N-Ac-galactosamine",
                ]
            )
            ...
            FRAGMENTS.append(
                [
                    SINGLE - MW("C11H19NO9") - MW("C8H15NO6") - MW("C6H12O6") + 2 * H2O,
                    62,
                    "NL deoxy-N-Ac-Neuraminic Acid + deoxyGalactose + N-Ac-Galactosamine ",
                ]
            )
            ...
            FRAGMENTS.append(
                [NL(self.chains[1]) - H2O + MW("NH3") + PROTON, 14, "sn2 fatty amide"]
            )

            # FRAGMENTS.append([MW("C11H19NO9") + PROTON, 12, "N-Ac-Neuraminic Acid"])
            FRAGMENTS.append(
                [MW("C11H19NO9") - H2O + PROTON, 284, "deoxy-N-Ac-Neuraminic Acid"]
            )
            FRAGMENTS.append(
                [
                    MW("C11H19NO9") - 2 * H2O + PROTON,
            ...
            FRAGMENTS.append(
                [MW("C8H15NO6") - H2O + PROTON, 635, "deoxy-N-Ac-glucosamine"]
            )
            FRAGMENTS.append(
                [
                    MW("C8H15NO6") - 2 * H2O + PROTON,
        ...
        if adduct == "[M+Na]+" or adduct == "[M+K]+" or adduct == "[M+Li]+":
            ...
            FRAGMENTS.append(
                [PREC - MW("C11H19NO9") + H2O, 65, "NL deoxy-N-Ac-Neuraminic Acid"]
            )
            ...
            FRAGMENTS.append(
                [
                    PREC - 2 * MW("C11H19NO9") - MW("C6H12O6") + 3 * H2O,
                    20,
                    "NL 2x deoxy-N-Ac-Neuraminic Acid + deoxygalactose",
                ]
            )
            ...
            FRAGMENTS.append(
                [MW("C8H15NO6") - H2O + PROTON, 10, "deoxy-N-Ac-glucosamine"]
            )
            FRAGMENTS.append(
                [MW("C8H15NO6") - 2 * H2O + PROTON, 8, "deoxy-N-Ac-glucosamine - water"]
            )
            FRAGMENTS.append(
                [MW("C11H19NO9") - H2O + PROTON, 4, "deoxy-N-Ac-Neuraminic Acid"]
            )
            FRAGMENTS.append(
                [
                    MW("C11H19NO9") - 2 * H2O + PROTON,
            ...
            FRAGMENTS.append(
                [
                    MW("C8H15NO6") + MW("C6H12O6") - 2 * H2O + PROTON,
                    12,
                    "deoxy-N-Ac-glucosamine + deoxygalactose",
                ]
            )
            FRAGMENTS.append(
                [
                    ...
                    81,
                    "deoxy-N-Ac-glucosamine + deoxygalactose + ADDUCT",
                ]
            )
            ...
            if adduct == "[M-H]-":
                ...
                FRAGMENTS.append(
                    [MW("C11H19NO9") - H2O - PROTON, 432, "deoxy-N-Ac-Neuraminic Acid"]
                )
                FRAGMENTS.append(
                    [
                ...
                FRAGMENTS.append(
                    [
                        PREC - MW("C11H19NO9") - MW("CO2") + H2O,
                        2,
                        "NL deoxy-N-Ac-Neuraminic Acid + CO2",
                    ]
                )
            ...
            if adduct == "[M-2H]2-":
                ...
                FRAGMENTS.append(
                    [MW("C11H19NO9") - H2O - PROTON, 612, "deoxy-N-Ac-Neuraminic Acid"]
                )
                FRAGMENTS.append(
                    [
                        MW("C11H19NO9") + MW("C11H19NO9") - 2 * H2O - PROTON,
                ...
                FRAGMENTS.append(
                    [SINGLE - MW("C11H19NO9"), 3, "NL N-Ac-Neuraminic Acid"]
                )
                ...
                FRAGMENTS.append(
                    [
                        SINGLE - 2 * MW("C11H19NO9") + 2 * H2O - MW("C6H10O5"),
                        3,
                        "NL 2x deoxy-N-Ac-Neuraminic Acid + deoxygalactose",
                    ]
                )
