    ...
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:
            if adduct == "[M+H]+":
                ...
                FRAGMENTS.append(
                    [
                        PREC - NL(self.chains[0]) + H2O - MW("CO2H2"),
                        10,
                        "NL Acyl + Formic Acid",
                    ]
                )
            ...
            if adduct in ["[M+Na]+", "[M+K]+", "[M+Li]+", "[M+NH4]+"]:
                ...
                FRAGMENTS.append(
                    [MW("C5H14NO4P") + ADDUCT[adduct], 1000, "Phosphocholine + Addcut"]
                )
                FRAGMENTS.append(
                    [MW("C2H5O4P") + ADDUCT[adduct], 700, "C2H6O4P + Adduct"]
                )
            ...
            FRAGMENTS.append(
                [PREC - MW("CO2") - MW("C5H14NO4P"), 10, "NL CO2 + phosphocholine"]
            )
