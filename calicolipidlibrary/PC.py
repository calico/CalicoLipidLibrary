    ...
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:
            if adduct == "[M+H]+":
                ...
                FRAGMENTS.append(
                    [MW("C5H14NO4P") + ADDUCT[adduct], 649, "Phospocholine"]
                )
                FRAGMENTS.append([PREC - MW("C3H9N"), 830, "NL Trimethylamine"])

                FRAGMENTS.append(
                    [PREC - MW("C5H15NO4P") + PROTON, 1000, "NL choline-P"]
                )
                ...
                FRAGMENTS.append(
                    [
                        PREC - NL(self.chains[i]) - MW("C3H9N"),
                        33,
                        "NL sn" + chain + "-trimethylamine",
                    ]
                )
            ...
            if adduct in ["[M+Na]+", "[M+K]+", "[M+Li]+", "[M+NH4]+"]:
                ...
                FRAGMENTS.append(
                    [MW("C2H5O4P") + ADDUCT[adduct], 567, "Phos + C2 + adduct"]
                )
                FRAGMENTS.append([PREC - MW("C3H9N"), 409, "NL Trimethylamine"])
                FRAGMENTS.append(
                    [PREC - (MW("C5H15NO4P") - PROTON), 464, "NL PhosphoCholine"]
                )
                FRAGMENTS.append(
                    [
                        PREC - (MW("C5H15NO4P") + ADDUCT[adduct]) + 2 * PROTON,
                        207,
                        "NL (PhosphoCholine + ADDUCT) +2*PROTON",
                    ]
                )  # should 2x proton really be 2x Hydrogen?
                FRAGMENTS.append(
                    [(MW("C5H14NO4P") + PROTON), 32, "PhosphoCholine + PROTON"]
                )
            ...
            if adduct != "[M-CH3]-":
                FRAGMENTS.append(
                    [PREC - ADDUCT[adduct] - MW("CH3"), 255, "NL adduct  + CH3"]
                )
            ...
            FRAGMENTS.append(
                [MW("C8H21NO6P") - PROTON - H2O - MW("CH3"), 26, "gPC- CH3-H2O"]
            )
            i = 0
            chain = str(i + 1)
            ...
            FRAGMENTS.append(
                [
                    PREC - ADDUCT[adduct] - MW("CH3") - NL(self.chains[i]) + H2O,
                    10,
                    "NL sn" + chain + "+H2O",
                ]
            )
            FRAGMENTS.append(
                [
                    PREC - ADDUCT[adduct] - MW("CH3") - NL(self.chains[i]),
                    7,
                    "NL sn" + chain,
                ]
            )
