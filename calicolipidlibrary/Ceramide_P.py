    ...
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:
            if adduct in ["[M+Na]+", "[M+K]+", "[M+Li]+", "[M+NH4]+"]:
                ...
                FRAGMENTS.append(
                    [MW("H3PO4") + ADDUCT[adduct], 95, "Phosphoric acid + adduct"]
                )
                FRAGMENTS.append([PREC - MW("H3PO4"), 995, "NL Phosphoric acid"])
                FRAGMENTS.append(
                    [
                        PREC - MW("H3PO4") - ADDUCT[adduct] + PROTON - H2O,
                        76,
                        "NL Phosphoric acid + water + adduct",
                    ]
                )

                FRAGMENTS.append(
                    [NL(self.chains[1]) - H2O + MW("NH3") + PROTON, 95, "fatty amide"]
                )
                FRAGMENTS.append(
                    [
                        PREC
                        ...
                        + PROTON,
                        7,
                        "N'': NL PhosphoCholine + sn2 ketene + water + ADDUCT",
                    ]
                )

                FRAGMENTS.append(
                    [
                        NL(self.chains[1]) - H2O + MW("NH3") + MW("C2") + PROTON,
                        44,
                        "fatty amide + C2",
                    ]
                )
            ...
            if adduct == "[M+H]+":
                ...
                FRAGMENTS.append(
                    [NL(self.chains[1]) - H2O + MW("NH3") + PROTON, 26, "fatty amide"]
                )
                FRAGMENTS.append(
                    [
                        PREC
                        ...
                        + PROTON,
                        1000,
                        "N'': NL PhosphoCholine + acyl ketene + water + ADDUCT",
                    ]
                )
                FRAGMENTS.append(
                    [
                        ...
                        + PROTON,
                        8,
                        "NL PhosphoCholine + fatty amide + water + ADDUCT",
                    ]
                )
