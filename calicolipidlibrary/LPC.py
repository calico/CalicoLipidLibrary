    ...
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:
            if adduct == "[M+H]+":
                ...
                FRAGMENTS.append(
                    [PREC - MW("C3H9N") - H2O, 9, "NL trimethylamine + water"]
                )
                FRAGMENTS.append([PREC - MW("C5H14NO4P"), 28, "NL phospho choline"])
                FRAGMENTS.append(
                    [MW("C8H20NO6P") + PROTON, 13, "glycerophosphocholine"]
                )
                FRAGMENTS.append(
            ...
            if adduct in ["[M+Na]+", "[M+K]+", "[M+Li]+", "[M+NH4]+"]:
                ...
                FRAGMENTS.append(
                    [MW("C2H5O4P") + ADDUCT[adduct], 243, "C2H5O4P + adduct"]
                )
            ...
            if self.chains[0][0] != 0:
                ...
                FRAGMENTS.append(
                    [PREC - ADDUCT[adduct] - MW("CH3"), 307, "pre-adduct-CH3"]
                )

                FRAGMENTS.append([MW("HPO3") - PROTON, 35, "PO3-"])
                FRAGMENTS.append([MW("C5H15NO4P") - PROTON - MW("CH3"), 21, "PC - CH3"])
                FRAGMENTS.append(
                    [MW("C3H9O6P") - PROTON - H2O, 8, "deoxyglycerol phosphate"]
                )
                ...
                i = 1
                FRAGMENTS.append(
                    [PREC - ADDUCT[adduct] - MW("CH3"), 156, "pre-adduct-CH3"]
                )
