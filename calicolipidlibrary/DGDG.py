    ...
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:
            if adduct == "[M+Na]+" or adduct == "[M+K]+":
                ...
                FRAGMENTS.append(
                    [
                        MW("C9H16O6") + MW("C6H10O5") + ADDUCT[adduct],
                        1000,
                        "dihexosylglycerol - 2 water +Adduct",
                    ]
                )
                FRAGMENTS.append(
                    [
            ...
            for i in range(0, len(self.chains)):
                ...
                FRAGMENTS.append(
                    [
                        ...
                        1000,
                        "sn" + chain + " acylium ion + glycerol- water",
                    ]
                )
            ...
            if adduct == "[M+NH4]+":
                ...
                FRAGMENTS.append(
                    [
                        PREC - MW("C12H22O11") + H2O - ADDUCT[adduct] + PROTON,
                        1000,
                        "NL deoxydihexose + adduct",
                    ]
                )
                FRAGMENTS.append(
                    [
                        PREC - MW("C12H22O11") - ADDUCT[adduct] + PROTON,
                        1000,
                        "NL dihexose +adduct ",
                    ]
                )
        ...
        if adduct in NEG_ADDUCTS:
            ...
            for i in range(0, len(self.chains)):
                ...
                FRAGMENTS.append([PREC - NL(self.chains[i]), 1000, "NL sn" + chain])
                FRAGMENTS.append(
                    [PREC - NL(self.chains[i]) + H2O, 1000, "NL sn" + chain + " ketene"]
                )

            FRAGMENTS.append(
                [
                    PREC - NL(self.chains[0]) - NL(self.chains[1]) + 2 * H2O,
                    1000,
                    "diglucose + glycerol",
                ]
            )
            FRAGMENTS.append(
                [
                    PREC - NL(self.chains[0]) - NL(self.chains[1]) + H2O,
                    1000,
                    "diglucose + deoxyglycerol",
                ]
            )
            FRAGMENTS.append(
                [
                    PREC - NL(self.chains[0]) - NL(self.chains[1]),
                    1000,
                    "diglucose +deoxyglycerol - water",
                ]
            )
