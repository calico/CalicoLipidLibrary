    ...
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:
            if adduct == "[M+H]+":
                ...
                FRAGMENTS.append(
                    [PREC - MW("C11H19NO9") + H2O, 9, "NL deoxy-N-Ac-Neuraminic Acid"]
                )
                FRAGMENTS.append(
                    [PREC - MW("C11H19NO9"), 55, "NL N-Ac-Neuraminic Acid"]
                )
                ...
                FRAGMENTS.append(
                    [
                        PREC - 2 * MW("C11H19NO9") - 2 * MW("C6H12O6") + 3 * H2O,
                        396,
                        "Ceramide",
                    ]
                )
                FRAGMENTS.append(
                    [
                        PREC - 2 * MW("C11H19NO9") - 2 * MW("C6H12O6") + 2 * H2O,
                        104,
                        "Ceramide - water",
                    ]
                )
                ...
                FRAGMENTS.append(
                    [MW("C11H19NO9") - H2O + PROTON, 416, "deoxy-N-Ac-Neuraminic Acid"]
                )
                ...
                FRAGMENTS.append(
                    [NL(self.chains[1]) - H2O + MW("NH3") + PROTON, 14, "fatty amide"]
                )
        ...
        # omitted [M=2H]2+ because reference spectrum was bad
            ...
            if adduct == "[M-H]-":
                ...
                FRAGMENTS.append(
                    [PREC - MW("C11H19NO9") + H2O, 792, "NL deoxy-N-Ac-Neuraminic Acid"]
                )
                ...
                FRAGMENTS.append(
                    [
                        PREC - 2 * MW("C11H19NO9") - 2 * MW("C6H10O5") + 2 * H2O,
                        21,
                        "Ceramide",
                    ]
                )
                ...
                FRAGMENTS.append(
                    [
                        PREC - 2 * MW("C11H19NO9") - MW("C6H10O5") + 2 * H2O,
                        14,
                        "Glucosyl ceramide",
                    ]
                )
            ...
            if adduct == "[M-2H]2-":
                ...
                FRAGMENTS.append(
                    [MW("C11H19NO9") - H2O - PROTON, 649, "deoxy-N-Ac-Neuraminic Acid"]
                )
                FRAGMENTS.append(
                    [
                        MW("C11H19NO9") + MW("C11H19NO9") - 2 * H2O - PROTON,
                ...
                FRAGMENTS.append(
                    [
                        SINGLE - 2 * MW("C11H19NO9") - 2 * MW("C6H10O5") + 2 * H2O,
                        21,
                        "Ceramide",
                    ]
                )
