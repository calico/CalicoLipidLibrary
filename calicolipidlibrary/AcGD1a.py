    ...
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:
            if adduct == "[M+H]+":
                ...
                FRAGMENTS.append(
                    [PREC - MW("C11H19NO9"), 12, "NL N-Ac-Neuraminic Acid"]
                )
                FRAGMENTS.append(
                    [
                ...
                FRAGMENTS.append(
                    [MW("C11H19NO9") - H2O + PROTON, 534, "deoxy-N-Ac-Neuraminic Acid"]
                )
                FRAGMENTS.append(
                    [
                ...
                FRAGMENTS.append(
                    [
                        MW("C11H19NO9") - 3 * H2O + PROTON,
                        74,
                        "deoxy-N-Ac-Neuraminic Acid - 2 water ",
                    ]
                )

                FRAGMENTS.append(
                    [MW("C8H15NO6") - H2O + PROTON, 527, "N-Ac-glucosamine - water"]
                )
                FRAGMENTS.append(
                    [
                ...
                FRAGMENTS.append(
                    [
                        ...
                        + PROTON,
                        243,
                        "deoxy-N-Ac-galcatosamine + deoxygalactose + dexoy-N-Ac-Neuraminic Acid",
                    ]
                )
                FRAGMENTS.append(
                    [
            ...
            if adduct == "[M+2H]2+":
                ...
                FRAGMENTS.append(
                    [MW("C11H19NO9") - H2O + PROTON, 318, "deoxy-N-Ac-Neuraminic Acid"]
                )
                FRAGMENTS.append(
                    [
                        MW("C11H19NO9") - 2 * H2O + PROTON,
                ...
                FRAGMENTS.append(
                    [MW("C8H15NO6") - H2O + PROTON, 190, "N-Ac-glucosamine - water"]
                )
                FRAGMENTS.append(
                    [
                        MW("C6H12O6") + MW("C11H19NO9") - 2 * H2O + PROTON,
            ...
            if adduct == "[M+Na]+" or adduct == "[M+K]+":
                ...
                FRAGMENTS.append(
                    [PREC - MW("C11H19NO9") + H2O, 382, "NL deoxy-N-Ac-Neuraminic Acid"]
                )
                FRAGMENTS.append(
                    [
                        PREC - MW("C11H19NO9") + H2O - MW("CO2"),
                        90,
                ...
                FRAGMENTS.append(
                    [
                        ...
                        + PROTON,
                        4,
                        "NL N-Ac-Neuraminic Acid + Galactose + ADDUCT ",
                    ]
                )
                FRAGMENTS.append(
                    [
                ...
                FRAGMENTS.append(
                    [MW("C11H19NO9") - H2O + PROTON, 5, "deoxy-N-Ac-Neuraminic Acid"]
                )
                FRAGMENTS.append(
                    [
                        MW("C11H19NO9") - 2 * H2O + PROTON,
                ...
                FRAGMENTS.append(
                    [MW("C8H15NO6") - H2O + PROTON, 6, "deoxy-N-Ac-glucosamine"]
                )
                FRAGMENTS.append(
                    [
                        MW("C8H15NO6") - H2O + ADDUCT[adduct],
                        8,
                        "deoxy-N-Ac-glucosamine + adduct",
                    ]
                )
                FRAGMENTS.append(
                    [
                        MW("C8H15NO6") - 2 * H2O + ADDUCT[adduct],
                        17,
                        "deoxy-N-Ac-glucosamine - water + adduct",
                    ]
                )
            ...
            if adduct == "[M-2H]2-":
                ...
                FRAGMENTS.append(
                    [MW("C11H19NO9") - H2O - PROTON, 343, "deoy-N-Ac-Neuraminic Acid"]
                )
                FRAGMENTS.append(
                    [
                ...
                FRAGMENTS.append(
                    [SINGLE - MW("C11H19NO9"), 4, "NL N-Ac-Neuraminic Acid"]
                )
                FRAGMENTS.append(
                    [
                        NL(self.chains[1]) - H2O + MW("C2H7NO") - H2O - PROTON,
