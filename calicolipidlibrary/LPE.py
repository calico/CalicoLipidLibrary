    ...
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:
            if adduct == "[M+H]+":
                ...
                FRAGMENTS.append(
                    [
                        MW("C5H14NO6P") - H2O + ADDUCT[adduct],
                        16,
                        "glycerol+phosphoethanolamine - H2O",
                    ]
                )
                FRAGMENTS.append([MW("C3H9O6P") + ADDUCT[adduct], 10, "glycerol-P"])
                FRAGMENTS.append(
                    [MW("C3H9O6P") + ADDUCT[adduct] - H2O, 60, "glycerol-P - H2O"]
                )
                FRAGMENTS.append(
                    [MW("C2H8NO4P") + ADDUCT[adduct], 13, "ethanolamine-P"]
                )
                FRAGMENTS.append(
                    [MW("C2H8NO4P") + ADDUCT[adduct] - H2O, 10, "ethanolamine-P - H2O"]
                )
            ...
            if adduct in ["[M+Na]+", "[M+K]+", "[M+Li]+", "[M+NH4]+"]:
                ...
                FRAGMENTS.append(
                    [MW("PO4H3") + ADDUCT[adduct], 215, "phosphoric acid + adduct"]
                )
                FRAGMENTS.append(
                    [MW("C2H8NO4P") + ADDUCT[adduct], 74, "ethanolamine-P + adduct"]
                )
                ...
                FRAGMENTS.append(
                    [
                        PREC - MW("C2H8NO4P") - ADDUCT[adduct] + PROTON,
                        397,
                        "NL ethanolamine-P + ADDUCT",
                    ]
                )
                ...
                FRAGMENTS.append(
                    [MW("C2H8NO4P") + ADDUCT[adduct] - H2O, 47, "ethanolamine-P - H2O"]
                )
                ...
                for i in range(0, (len(self.chains))):
                    ...
                    FRAGMENTS.append(
                        [
                            PREC - MW("C2NH5") - NL(self.chains[i]),
                            40,
                            "NL sn1 + deoxyethanolamine",
                        ]
                    )
            ...
            if self.chains[0][0] != 0:
                ...
                FRAGMENTS.append(
                    [MW("C3H9O6P") - H2O - PROTON, 10, "glycerol3P - water"]
                )
                FRAGMENTS.append([MW("HPO3") - PROTON, 42, "phosphite"])
                FRAGMENTS.append(
                    [
                        MW("C2H8NO4P") - H2O + ADDUCT[adduct],
                        2,
                        "deoxyethanolamine-P + adduct",
                    ]
                )
                FRAGMENTS.append(
                    [MW("C2H8NO4P") + ADDUCT[adduct], 32, "ethanolamine-P + adduct"]
                )
