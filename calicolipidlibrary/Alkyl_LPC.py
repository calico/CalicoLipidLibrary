    ...
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:
            if adduct == "[M+H]+":
                ...
                FRAGMENTS.append(
                    [
                        MW("C8H20NO6P") - H2O + PROTON,
                        108,
                        "Glycero-phosphocholine - water",
                    ]
                )
                FRAGMENTS.append(
                    [
                        MW("C8H20NO6P") - MW("C3H9N") - H2O + PROTON,
                        101,
                        "Glycero-phosphocholine - water - trimethylamine",
                    ]
                )
                FRAGMENTS.append(
                    [MW("C5H14NO4P") + ADDUCT[adduct], 180, "Phospocholine"]
                )
            ...
            if adduct in ["[M+Na]+", "[M+K]+", "[M+Li]+", "[M+NH4]+"]:
                ...
                FRAGMENTS.append(
                    [
                        MW("C8H20NO6P") - MW("C3H9N") - H2O + ADDUCT[adduct],
                        2,
                        "Glycero-phosphocholine - water - trimethylamine + adduct",
                    ]
                )
                FRAGMENTS.append([PREC - MW("C5H13NO"), 11, "NL choline"])
                FRAGMENTS.append(
                    [MW("C2H5O4P") + ADDUCT[adduct], 1000, "C2H5O4P + Adduct"]
                )
            ...
            FRAGMENTS.append(
                [PREC - ADDUCT[adduct] - PROTON - MW("CH3"), 1000, "NL CH3 + Adduct"]
            )
