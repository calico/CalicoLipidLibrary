    ...
    def theoreticalDigest(self):
        ...
        if adduct in POS_ADDUCTS:
            ...
            if adduct != "[M-H]-":
                ...
                FRAGMENTS.append(
                    [PREC - ADDUCT[adduct] - MW("CH3"), 310, "NL adduct + CH3"]
                )
                ...
                FRAGMENTS.append(
                    [
                        NL(self.chains[0]) - MW("O2") + MW("H4") - PROTON,
                        57,
                        "sn1 alkene",
                    ]
                )
                ...
                FRAGMENTS.append(
                    [
                        PREC - ADDUCT[adduct] - MW("C5H12N") - NL(self.chains[1]) + H2O,
                        1,
                        "NL deoxycholine + sn2 + H2O",
                    ]
                )
                FRAGMENTS.append(
                    [
                        PREC - ADDUCT[adduct] - MW("C5H12N") - NL(self.chains[1]),
                        14,
                        "NL deoxycholine + sn2",
                    ]
                )
                ...
                FRAGMENTS.append(
                    [
                        PREC - ADDUCT[adduct] - MW("CH3") - NL(self.chains[1]) + H2O,
                        57,
                        "NL adduct + CH3 + sn2 + H2O",
                    ]
                )
                FRAGMENTS.append(
                    [
                        PREC - ADDUCT[adduct] - MW("CH3") - NL(self.chains[1]),
                        25,
                        "NL adduct + CH3 + sn2",
                    ]
                )
